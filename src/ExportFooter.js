          ...
          <div className='socialshare'>
            <a className="twitter-share-button twittershare" onClick={this.tweet} href="#">
              <div className='twitter'>
                <svg width="30" height="30" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a onClick={this.post} href="#">
              <div className='fb'>
                <svg width="27" height="27" viewBox="0 0 7 15" fill="none" xmlns="http://www.w3.org/2000/svg">
